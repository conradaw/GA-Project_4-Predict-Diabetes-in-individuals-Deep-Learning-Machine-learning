...
with tab1:
    st.image('/Users/conra/GA/personal/project_4/streamlit/myhealthapp/diabetes_banner.jpg', width=700)  # Example banner - ensure you have an image named 'diabetes_banner.jpg'
    st.markdown("""
<style>
.safe-text-color {
...
""", unsafe_allow_html=True)
    ...
    def load_model():
        with open('/Users/conra/GA/personal/project_4/streamlit/myhealthapp/tuned_models_gs.pkl', 'rb') as file:
...
with tab2:
    st.image("/Users/conra/GA/personal/project_4/streamlit/myhealthapp/nutrigrade_banner.jpg", width=700)  # Example banner - ensure you have an image named 'diabetes_banner.jpg'
    st.markdown("""
<style>
.safe-text-color {
    color: #787878;  /* Medium gray for good contrast in both light and dark themes */
...
""", unsafe_allow_html=True)
    ...
    def extract_sugar_content(image_path):
        ...
        serving_size_match = re.search(serving_size_pattern, extracted_text)
        ...
        sugar_matches = re.findall(sugar_pattern, extracted_text)
        if sugar_matches:
            ...
            st.write(f"Total sugar content per 100 ml: {sugar_per_100ml} g")
        else:
